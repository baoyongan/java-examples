...
public class FlowControlFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        selectorThread = new Thread(new SelectorRunner(),"selectThread000000000000000000");
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        boolean buffered = waitingQueue.offer(node); // 添加到队列
        //如果buffer已满
        if (!buffered) {
            if(errorUrl != null) {
        ...
        //进入等待队列后，当前线程阻塞,并设置最长阻塞时间
        LockSupport.parkNanos(this, TimeUnit.MILLISECONDS.toNanos(timeout));
        ...
        //如果等待过期，则直接返回 （可能是超时接触阻塞，也可能是出队后unpark,正好超时）
    ...
    private class Node {
         ...
         *
         * @param t
         * @param dequeued false 未出队，true 已出队
         */
