 ...
 */
package com.bya.zk.foo.demo.lock;
 ...
 *  write lock or to elect a election</a>. <p/> You invoke {@link #lock()} to
...
public class WriteLock extends ProtocolSupport {
    ...
    private class LockWatcher implements Watcher {
        public void process(WatchedEvent event) {
            // lets either become the election or watch the new/updated node
