...
public class SyncPrimitive implements Watcher {
    ...
    SyncPrimitive(String address) {
        if (zk == null) {
            try {
                ...
                zk = new ZooKeeper(address, 100000, this);
                mutex = new Integer(-1);
    ...
    public static void queueTest(String args[]) {
        Queue q = new Queue("192.16.30.46:2181,192.16.30.52:2181,192.16.30.54:2181", "/app1");
    ...
    public static void barrierTest(String args[]) {
        ...
        Barrier b = new Barrier("192.16.30.46:2181,192.16.30.52:2181,192.16.30.54:2181", "/b1", 5, args[0]);
        try {
